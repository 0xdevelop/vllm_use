...
export type Runtime={status:RuntimeStatus;pid:number;active_model_id?:string;started_at?:string;ready_at?:string;stopped_at?:string;exit_error?:string;exit_code?:number;logs:string[]}
